...
//        $this->capture = 'yes' === $this->get_option('capture');
    ...
    public function payment_fields()
    {
        ...
        $creditcardimg = plugins_url( '../assets/images/creditcard.png', __FILE__ );
        echo "<div style='padding:1.25em 0 0 0;margin-top:-1.25em;display:inline-block;'><img style='float: left;max-height: 2.8125em;' src='$creditcardimg' alt=''></div>";
        echo '<div
